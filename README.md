...
A lightweight, automated data-extraction utility designed to parse modular item statistics, generation rules, and loot pools directly from Borderlands 4 NexusConfigStore Dumps. This tool converts complex, nested JSON schemas into clean, flat tables (CSV).
